...
//        System.out.println("Car make is " + eachCarSplitted[0] + " , " + " Car model is " + eachCarSplitted[1]);
     ...
     // and we dont need index so we used for each loop
//        for (String eachCar : cars ) {
//            // we want to do this action only for one type of car brand
//            // so we used startWith method to check car brand
...
//        }
        ...
        System.out.println("Count of Cars with only 2 character in their model = " + cntOf2Char);
