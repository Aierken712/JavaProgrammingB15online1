...
//           task1
//        int cntRestaurants = 0;
//        for (int i = 0; i <restaurants.length ; i++) {
//            cntRestaurants++;
//        }
//        System.out.println("Total number of restaurants: " + cntRestaurants);
...
//                System.out.println(num + x + ". " + restaurants[x]);
//        }
...
//        for (int i = 0; i < restaurants.length ; i++) {
//
//            if( restaurants[i].contains(name) || restaurants[i].equalsIgnoreCase("m")  ) {
//                mcdonaldCount++;
//            }
//
//        }
//        System.out.println("McDonald's Count: "+ mcdonaldCount);

        //task 4
//        int popeyesCount = 0;
//        int dominosCount = 0;
//        int tacoBellCount = 0;
//        String name1 = "Popeye's Chicken";
//        String name2 = "Domino's Pizza";
//        String name3 = "Taco Bell";
//
//        for (int i = 0; i <restaurants.length ; i++) {
//            if(restaurants[i].contains(name1) || restaurants[i].equalsIgnoreCase("p") ){
//                popeyesCount++;
//
//            }else if(restaurants[i].contains(name2) || restaurants[i].equalsIgnoreCase("d")){
//                dominosCount++;
//
//            }else if(restaurants[i].contains(name3) || restaurants[i].equalsIgnoreCase("t")){
//                tacoBellCount++;
//            }
//            }
//        System.out.println("Count number of Popeye's Chicken " + popeyesCount);
//        System.out.println("Count number of Domino's Pizza " + dominosCount);
//        System.out.println("Count number of Taco Bell " + tacoBellCount);

        //task5
//        int num = 1;
//        for(int i = 0; i<restaurants.length;i++) {
//            if (restaurants[i].contains("McDonald's") && restaurants[i].contains("TX")) {
//                System.out.println(num + ". " + restaurants[i]);
//                num++;
//            }
//        }
...
//        String[] firstRestaurantSplited = restaurants[0].split(",");
//        //System.out.println(restaurants[0] );
//        System.out.println(Arrays.toString(firstRestaurantSplited) );
//        System.out.println(firstRestaurantSplited[2] + " -> " + firstRestaurantSplited[1] + ", " + firstRestaurantSplited[4]);

        // task 7

//            int num = 1;
//            for (int i = 0; i <restaurants.length ; i++) {
//               String  firstRestaurant = restaurants[i];
//               String[] firstRestaurantSplited = restaurants[i].split(",");
//               System.out.println(num + ". " + firstRestaurantSplited[2] + " -> " + firstRestaurantSplited[1] + ", " + firstRestaurantSplited[4]);
//                num++;
//            }
...
//        System.out.println(items.length + ", " + prices.length + ", " + itemIDs.length);
...
//            System.out.println(itemIDs[i] + " - " + prices[i] + " - " + items[i]);
//        }
//        double totalPrice = 0.0;
//        for (int i = 0; i <prices.length ; i++) {
//            totalPrice += prices[i];
//        }
//        System.out.println( " Total price: " + (totalPrice + totalPrice*0.06) );
...
//     1) -->   for(double eachPrice : prices){
//               if(maxPrice<eachPrice){
//                maxPrice=eachPrice;
//               }
//              }
//             System.out.println("Most expensive item: " + maxPrice);
//             maxPriceIndex = prices.length-2;
...
//             }
 //       }
    ...
    public boolean method(String password){
